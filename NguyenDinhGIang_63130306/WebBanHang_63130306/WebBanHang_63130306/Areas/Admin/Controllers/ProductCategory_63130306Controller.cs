...
{
    public class ProductCategory_63130306Controller : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();
        // GET: Admin/ProductCategory_63130306
        ...
        public ActionResult Add(ProductCategory_63130306 model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(ProductCategory_63130306 model)
        {
            if (ModelState.IsValid)
            {
                model.ModifiedDate = DateTime.Now;
