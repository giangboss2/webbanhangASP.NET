...
namespace WebBanHang_63130306.Areas.Admin.Controllers
{
   // [Authorize(Roles = "Admin")]
    public class Category_63130306Controller : Controller

    { 
      //  GET: Admin/Category_63130306
        ...
        public ActionResult Add(Category_63130306 model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Category_63130306 model)
        {
            if (ModelState.IsValid)
            {
